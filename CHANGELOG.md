...
- Bump Android SDK from v7.14.0 to v7.16.0 ([#359](https://github.com/getsentry/sentry-cordova/pull/359))
  - [changelog](https://github.com/getsentry/sentry-java/blob/7.16.0/CHANGELOG.md)
