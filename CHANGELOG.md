...
- Bump Sentry JavaScript SDK to `7.118.0` ([#354](https://github.com/getsentry/sentry-cordova/pull/354))
  - [changelog](https://github.com/getsentry/sentry-javascript/releases/tag/7.118.0)
